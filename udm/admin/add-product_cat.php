	...
	if($row>0)
{
	...
	if(move_uploaded_file($_FILES["image"]["tmp_name"],'../proimage/'.$filename)){
		// Image db insert sql
		$insert = "INSERT into product (product_name,product_description,product_img,price,cat,date) values('$product_name','$description','$filename','$price','$cat',now())";
