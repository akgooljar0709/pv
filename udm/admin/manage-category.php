 ...
 if(isset($_POST['search']))
{
    ...
    $query = "SELECT * FROM `category` WHERE CONCAT(`cat_id`, `category_name`) LIKE '%".$valueToSearch."%'";
			...
			<div class="table-data">
				<div class="order">
					<div class="head">
						...
						<a href="add-category.php" class="btn-download">
                      ...
                      while ($row = mysqli_fetch_array($search_result)) {
                          ?>
                                <tr>
                                    ...
                                    <td>
                                        <a href="update-category.php?id=<?php echo $row['cat_id']?>" class="btn btn-primary">EDIT</a>
                                        <a href="delete_category.php?cid=<?php echo $row['cat_id']; ?>" class="btn btn-danger" onClick="javascript:return confirm('Do you really want to delete?');" >DELETE</a>
