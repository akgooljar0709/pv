 ...
 if(isset($_POST['search']))
{
    ...
    $query = "SELECT * FROM `admin` WHERE uname LIKE '%$valueToSearch%' OR email LIKE '%$valueToSearch%' OR role LIKE '%$valueToSearch%'";
                      ...
                      while ($row = mysqli_fetch_array($search_result)) {
                          ?>
                                <tr>
                                    ...
                                    <td>
                                        <a href="update-users.php?id=<?php echo $row['aid']?>" class="btn btn-primary">EDIT</a>
                                        <a href="delete.php?aid=<?php echo $row['aid']; ?>" class="btn btn-danger" onClick="javascript:return confirm('Do you really want to delete?');" >DELETE</a>
