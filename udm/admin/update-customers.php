...
<?php
  ...
  if(isset($_POST['submit']))
  {
	    ...
	    //Query for data updation
	     $query=mysqli_query($conn, "UPDATE `users` SET name ='$fname',email = '$email' where id = '$id'");
      ...
      ?>
         ...
         <form method="POST" >
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-7">
                <input type="text" name="first_name" class="form-control" id="first_name" placeholder="First Name" value="<?php echo $row['name']; ?>">
                </div>
            </div>
