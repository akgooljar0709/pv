...
<body>
    ...
    <div class="info"></div>
     ...
     include "conn.php";
      ...
      $ret=mysqli_query($conn,"SELECT orders.id, users.name, orders.orderDate,product.product_name,product.price,orders.quantity FROM orders INNER JOIN users ON orders.userId=users.id join product on product.id=orders.productId where userId = 9");
      ...
      ?>
         ...
         <form method="POST" >
            ...
            <div class="form-group row">
                ...
                <label for="product_description" class="col-sm-3 col-form-label">Order Date</label>
                <div class="col-sm-7">
