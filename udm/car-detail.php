...
<br>
  ...
  <tr>
    ...
    <th>Contact</th>
    <th class="color_back"><image src = 'images/car-sold-icon.png'></th>
  </tr>
  
 <?php 
                                    $conn = mysqli_connect("localhost","root","root","sec_udm_project");

                                    if(isset($_GET['search']))
                                    {
                                        $search_id=$_GET['select'];
                                        $query = "select * from carbrands where brand_id like '$search_id%' ";
                                        ...
                                        if(mysqli_num_rows($query_run) > 0)
                                        {
                                            foreach($query_run as $items)
                                            {
                                                ...
                                                <tr>
                                                    ...
                                                    <td><b>Brand Name : </b><?= $items['brand_name']; ?></td>
