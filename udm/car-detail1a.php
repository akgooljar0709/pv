      ...
      <table class="table table-sm" >
        ...
        <?php 
                                    ...
                                    if(isset($_GET['search']))
                                    {
                                        ...
                                        $query = "SELECT distinct  a.id_type , b.name_energy , c.name_power , d.name_consumption , e.name_distance , f.name_durer ,  g.name_make   FROM type as a , energy as b , power as c , consumption as d ,
                                                  distance as e , durer as f , make as g WHERE

                                                   d.name_consumption = '$fuel_comsumption'
                                                   and a.id_type = '$type' 
                                                   and  b.name_energy ='$energy'
                                                   and  c.name_power  ='$power' 
                                                   and e.name_distance = '$distance'
                                                   and f.name_durer = '$durer'
                                                   and g.name_make = '$ve_make' 
                                        ...
                                        if(mysqli_num_rows($query_run) > 0)
                                        {
                                            foreach($query_run as $items)
                                            {
                                                ...
                                                <tr>
                                                  ...
                                                  <td> <b>Brand :</b> <?php echo $items['name_make']; ?> </td>
        ...
        <?php 
                                    ...
                                    if(isset($_GET['search']))
                                    {
                                        ...
                                        $query = "SELECT  make_ve , acceleration_ve , 
                                                  ...
                                                  from ve as g WHERE g.make_ve = '$ve_make'  order by model_ve asc ";  
                                        $query_run = mysqli_query($conn, $query);
