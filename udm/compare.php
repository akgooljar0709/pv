...
<title>PV EV Compare Page</title>
    ...
    <div class="breadcrumbs">
      <div class="container">
        <div class="row">
          ...
          <div class="col-xs-12">
            <ul>
              <li class="home"> <a href="index-2.html" title="Go to Home Page"> </a> <span>&rsaquo; </span> </li>
...
$search_id=$_GET['select'];
$ret=mysqli_query($conn,"select * from carbrands where brand_id like '$search_id%'");
...
{?> 
						<div class="col-md-3 col-sm-4 col-xs-12 col-md-offset-3">
							<div>
								...
								<img src="products-images/p48.jpg" alt="image">
...
<?php } ?>  
						<div class="col-md-3 col-sm-4 col-xs-12 ">
							<div>
								...
								<img src="products-images/p47.jpg" alt="image">
						...
						<div class="col-md-3 col-sm-4 col-xs-12">
							<div>
								...
								<img src="products-images/p49.jpg" alt="image">
								<div class="b-compare-price">$120,440</div>
							</div>
						</div>
					</div>
				</div>     
   ...
   <h2 style="background: #50b2fc;">Basic Information</h2>
					...
					<div class="b-compare-block">
                    <h2 style="background-color: #3e6274;">EXTERIOR / INTERIOR FEATURES</h2>
						<div class="row">
							<div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
								<div class="b-compare__block-inside-title">
									All Season Tires
