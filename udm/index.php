  ...
  <div class="panel panel-default">
        ...
        <?php $sql = "SELECT * FROM carbrands";
          ...
          <div class="form-group">
            ...
            <h6>Car Model</h6>
              <select  class="form-select"  name="select_cat" id="show" data-width="100%" tabindex="-98"></select>
          </div>

          <div class="form-group">
           
            <h6>Car Model</h6>
              <select  class="form-select"  name="select_cat" id="show_type" data-width="100%" tabindex="-98"></select>
          </div>


          <div class="form-group">
            <button type="submit" class="search-button" name="search" style="background-color: #0cb10c;">
            Compare</button>
