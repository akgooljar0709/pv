...
?>
<br>
<form action="car-detail.php" method="get">
 <div class="container">
  ...
  <div class="panel panel-default">
        ...
        <div class="panel-heading"><h2>Compare Your Car</h2></div>
        <div class="panel-body">
          <div class="form-group">
           

              <label>Select Category</label>
            <select class="form-select" name="select" id="selectID" data-width="100%" tabindex="-98">
        ...
        <?php $sql = "SELECT * FROM carbrands";
          ...
          <div class="form-group">
            ...
            <h6>Car Model</h6>
              <select  class="form-select"  name="select_cat" id="show" data-width="100%" tabindex="-98">
          ...
          <div class="form-group">
            ...
            <h6>Average daily distance (km)</h6>
          ...
          <div class="form-group">
            ...
            <h6>Daily route duration (minutes)</h6>
...
<script type="text/javascript">
    ...
    //JAVASCRIPT pour afficher les dropdowns depuis la database
  ...
  $(document).ready(function(){
    ...
    $('.types').change(function(){
      ...
      $('.energy').find("option:eq(0)").html("Please wait..");
        ...
        success: function (data) {
          /*get response as json */
           $('.energies').find("option:eq(0)").html("Type of energy");
          var obj=jQuery.parseJSON(data);
          $(obj).each(function()
          {
           var option = $('<option />');
    ...
    $('.energies').change(function(){
      $.ajax({
        type: "POST",
        url: "dropdown/get_make.php",
        data:{id:$(this).val()}, 
        beforeSend :function(){
      $(".makes option:gt(0)").remove(); 
      $(".powers option:gt(0)").remove(); 
      $('.makes').find("option:eq(0)").html("Please wait..");

        },                         
        success: function (data) {
          /*get response as json */
           $('.makes').find("option:eq(0)").html(" Make");
          var obj=jQuery.parseJSON(data);
          $(obj).each(function()
          {
           var option = $('<option />');
...
/*Get the type power */
 $('.makes').change(function(){
      ...
      $('.powers').find("option:eq(0)").html("Please wait..");
        ...
        success: function (data) {
          /*get response as json */
           $('.powers').find("option:eq(0)").html("Horsepower");
          var obj=jQuery.parseJSON(data);
          $(obj).each(function()
          {
           var option = $('<option />');
...
/*Get the type consumption */
 $('.powers').change(function(){
      $.ajax({
        ...
        data:{id:$(this).val()}, 
        beforeSend :function(){
      $('.consumption').find("option:eq(0)").html("Please wait..");
        },                         
        success: function (data) {
          /*get response as json */
           $('.consumption').find("option:eq(0)").html("Consumption (L/100 km)");
          var obj=jQuery.parseJSON(data);
          $(obj).each(function()
          {
           var option = $('<option />');
           option.attr('value', this.value).text(this.label);           
           $('.consumption').append(option);
         });  
...
/*Get the type average daily distance */
 $('.consumption').change(function(){
      $.ajax({
        ...
        data:{id:$(this).val()}, 
        beforeSend :function(){
      $('.distance').find("option:eq(0)").html("Please wait..");
        },                         
        success: function (data) {
          /*get response as json */
           $('.distance').find("option:eq(0)").html("Daily distance (km)");
          var obj=jQuery.parseJSON(data);
          $(obj).each(function()
          {
           var option = $('<option />');
 ...
 $('.distance').change(function(){
      ...
      $(".durer option:gt(0)").remove(); 
        ...
        success: function (data) {
          /*get response as json */
            $('.durer').find("option:eq(0)").html("Route duration (minutes)");
